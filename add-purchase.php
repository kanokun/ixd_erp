...
$stmt->execute();
$type_purchase_list = $stmt->fetchAll(PDO::FETCH_ASSOC);

$stmt = $dbh->prepare("SELECT A.*,B.name AS company_self_name, C.name AS company_name, D.name AS type_name FROM $table A, company_self B, company C, type_purchase D WHERE A.id_comp_self = B.id AND A.id_comp = C.id AND A.id_type = D.id ORDER BY A.date DESC");
$stmt->execute();
...
?>
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">매입 추가</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-building-o"></i> 매입 입력 폼</div>
        <div class="card-body">
			<form id="form-add" action="db-modify-row.php" method="post" target="ifr-hidden" >
              ...
              <div class="form-group">
                <div class="form-row">
                	...
                	<div class="col-md-6">
    					...
    					<?php
    					foreach($type_purchase_list as $row){
                        ?>
                        	<option value=<?=$row['id']?>><?=$row['name']?></option>
                        <?php
                        }
              ...
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-6">
                    <label for="input-date" class="label-need">날짜</label>
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> 매입 리스트</div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              ?>
              	<tr>
              		...
              		<td>
              			<a class="btn btn-sm btn-primary btn-purchase-info" id="btn-purchase-info-<?=$row['id']?>" >+</a>
    ...
    <div class="modal fade modal-purchase-info" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<form id="form-modify" action="db-modify-row.php" method="post" target="ifr-hidden" >
                  ...
                  <div class="form-group">
                    <div class="form-row">
                        <div class="col-md-6">
                          <label for="input1-date" class="label-need">날짜</label>
...
<?php include_once('footer.php') ?>
    ...
    $(".btn-type-info").click(function() {
        ...
        $.ajax({
            dataType:"json",
            url:"db-select-row.php?query=SELECT * FROM type_purchase WHERE `id`=" + id + " limit 1"
        }).done(function(data) {
    ...
    $(".btn-purchase-info").click(function() {
