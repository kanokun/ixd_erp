    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> 매출 관련 차트
        </div>
        ...
        <div class="row">
            <div class="col-lg-8">
              ...
              <div class="card mb-3 card-inside">
                <div class="card-header">
                  <i class="fa fa-bar-chart"></i> 기간별 매출액
            ...
            <div class="col-lg-4">
              ...
              <div class="card mb-3 card-inside">
                <div class="card-header">
                  <i class="fa fa-pie-chart"></i> 기간별 매출 품목
                  <div class="card-toggle"><i class="fa fa-chevron-up" aria-hidden="true"></i></div>
                </div>
                <div class="card-body">
...
function setChart() {
	...
	query = "SELECT A.*,B.name as company_self_name, C.name as company_name, D.name as type_name, E.name as acc_name FROM <?=$table?> A, company_self B, company C, type_sales D, account E WHERE A.id_comp_self = B.id AND A.id_comp = C.id AND A.id_type = D.id AND A.id_acc = E.id AND ";
